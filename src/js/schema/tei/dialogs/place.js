    ...
    '<div class="annotationDialog">'+
        ...
        '<div>'+
            ...
            '<div id="'+id+'_precision" data-transform="buttonset" data-type="radio" data-mapping="custom.precision">'+
                '<input type="radio" id="'+id+'_p_high" name="'+id+'_detail_radio" value="high" /><label for="'+id+'_p_high">High</label>'+
                '<input type="radio" id="'+id+'_p_medium" name="'+id+'_detail_radio" value="medium" /><label for="'+id+'_p_medium">Medium</label>'+
                '<input type="radio" id="'+id+'_p_low" name="'+id+'_detail_radio" value="low" /><label for="'+id+'_p_low">Low</label>'+
                '<input type="radio" id="'+id+'_p_unknown" name="'+id+'_detail_radio" value="unknown" /><label for="'+id+'_p_unknown">Unknown</label>'+
            '</div>'+
        '</div>'+
